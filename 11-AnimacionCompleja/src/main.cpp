...
void init(int width, int height, std::string strTitle, bool bFullScreen) {
	...
	modelHeliMid.setShader(&shaderMulLighting);
...
void applicationLoop() {
	...
	while (psi) {
		...
		modelMatrixEclipseFrontalWheels = glm::rotate(modelMatrixEclipseFrontalWheels, rotWheelsy, glm::vec3(0, 1, 0));
		modelMatrixEclipseFrontalWheels = glm::rotate(modelMatrixEclipseFrontalWheels, rotWheels, glm::vec3(1, 0, 0));
		modelMatrixEclipseFrontalWheels = glm::translate(modelMatrixEclipseFrontalWheels, glm::vec3(0, -1.06285, -4.11795));
		...
		modelMatrixEclipseRearWheels = glm::translate(modelMatrixEclipseRearWheels, glm::vec3(0, 1.05128, -4.3465));
		modelMatrixEclipseRearWheels = glm::rotate(modelMatrixEclipseRearWheels, rotWheels, glm::vec3(1, 0, 0));
		modelMatrixEclipseRearWheels = glm::translate(modelMatrixEclipseRearWheels, glm::vec3(0, -1.05128, 4.3465));
		...
		modelMatrixHeliHeli = glm::rotate(modelMatrixHeliHeli, rotHeliHeli, glm::vec3(0, 1, 0));
		modelMatrixHeliHeli = glm::translate(modelMatrixHeliHeli, glm::vec3(0.003344, -1.88318, 0.254566));
		...
		case 1:
			...
			rotCount += 0.5f;
			rotWheelsy += 0.01;
			if (rotWheelsy > glm::radians(15.0)){
				rotWheelsy = glm::radians(15.0);
			}
			if(rotCount >= 90.0){
				rotCount = 0;
				state = 0;
