...
GLuint textureID1, textureID2, textureID3, textureID4, textureID5, textureID6, textureID7, textureID8, textureID9, textureID10, textureID11, textureID12, textureID13;
...
void init(int width, int height, std::string strTitle, bool bFullScreen) {
	...
	Camino.init();
	Camino.setShader(&shaderMulLighting);
	...
	// Definiendo la textura a utilizar
	Texture texture13("../Textures/asfalto 17.jpg");
	// Carga el mapa de bits (FIBITMAP es el tipo de dato de la libreria)
	// Voltear la imagen
...
void applicationLoop() {
	...
	//matrixModelEclipse = glm::scale(matrixModelEclipse, glm::vec3(0.5, 0.5, 0.5));
	matrixModelEclipse = glm::translate(matrixModelEclipse, glm::vec3(-40.0, 0.5, 24.0));
	matrixModelEclipse = glm::rotate(matrixModelEclipse, glm::radians(90.0f), glm::vec3(0, 1.0, 0));
	...
	while (psi) {
		...
		shaderMulLighting.setVectorFloat3("pointLights[0].position", glm::value_ptr((glm::vec3(-44.0, 9.0, -2.0))));
		...
		shaderMulLighting.setVectorFloat3("pointLights[1].position", glm::value_ptr((glm::vec3(-46.0, 9.0, -2.0))));
		...
		shaderMulLighting.setVectorFloat3("pointLights[2].position", glm::value_ptr((glm::vec3(-48.0, 9.0, -2.0))));
		...
		shaderMulLighting.setVectorFloat3("pointLights[3].position", glm::value_ptr((glm::vec3(-50.0, 9.0, -2.0))));
		...
		shaderMulLighting.setVectorFloat3("pointLights[4].position", glm::value_ptr((glm::vec3(-52.0, 9.0, -2.0))));
		...
		sphereLamp.setPosition(glm::vec3(-44.0, 9.0, -2.0));
		sphereLamp.setColor(glm::vec4(0.0, 1.0, 0.0, 1.0));
		sphereLamp.render();

		sphereLamp.setScale(glm::vec3(0.1, 0.1, 0.2));
		sphereLamp.setPosition(glm::vec3(-46.0, 9.0, -2.0));
		sphereLamp.setColor(glm::vec4(1.0, 0.0, 0.0, 1.0));
		sphereLamp.render();

		sphereLamp.setScale(glm::vec3(0.1, 0.1, 0.2));
		sphereLamp.setPosition(glm::vec3(-48.0, 9.0, -2.0));
		sphereLamp.setColor(glm::vec4(0.0, 0.0, 1.0, 1.0));
		sphereLamp.render();

		sphereLamp.setScale(glm::vec3(0.1, 0.1, 0.2));
		sphereLamp.setPosition(glm::vec3(-50.0, 9.0, -2.0));
		sphereLamp.setColor(glm::vec4(0.8, 0.8, 0.0, 1.0));
		sphereLamp.render();

		sphereLamp.setScale(glm::vec3(0.1, 0.1, 0.2));
		sphereLamp.setPosition(glm::vec3(-52.0, 9.0, -2.0));
		...
		modelEclipse.render(matrixModelEclipse);
		glActiveTexture(GL_TEXTURE0);

		modelHeli.render(matrixModelHeli);
		glActiveTexture(GL_TEXTURE0);

		glm::mat4 matrixModelMesa = glm::mat4(1.0);
		matrixModelMesa = glm::translate(matrixModelMesa, glm::vec3(-48.0, 1.0, 5.0));
		...
		//Camino
		glm::mat4 modelCamino = glm::mat4(1.0);
		modelCamino = glm::translate(modelCamino, glm::vec3(-30.0, 0.0, 24.0));
		modelCamino = glm::scale(modelCamino, glm::vec3(60.0, 0.01, 8.0));
		glBindTexture(GL_TEXTURE_2D, textureID13);
		Camino.render(modelCamino);
		glBindTexture(GL_TEXTURE_2D, 0);
		...
		case 1:
			...
			matrixModelEclipse = glm::translate(matrixModelEclipse, glm::vec3(0.0, 0.0, 0.0));
			matrixModelEclipse = glm::rotate(matrixModelEclipse, glm::radians(1.0f), glm::vec3(0, 1, 0));
			matrixModelHeli = glm::translate(matrixModelHeli, glm::vec3(0.0, -0.11111, 0.0));
			rotCount += 0.5f;
