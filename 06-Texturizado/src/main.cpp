...
void init(int width, int height, std::string strTitle, bool bFullScreen) {
	...
	cylinder3.setColor(glm::vec4(0.803, 0.521, 0.247, 1.0));
	...
	box4.setColor(glm::vec4(0.803, 0.521, 0.247, 1.0));
...
void applicationLoop() {
	...
	while (psi) {
		...
		//3glBindTexture(GL_TEXTURE_2D, 0);
		...
		//box2.enableWireMode();
		box4.render(glm::scale(p, glm::vec3(1.0, 0.25, 0.1)));
