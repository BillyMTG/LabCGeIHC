...
std::string fileNames[6] = { "../Textures/ame_desert/desertsky_ft.tga",
		"../Textures/ame_desert/desertsky_bk.tga",
		"../Textures/ame_desert/desertsky_up.tga",
		"../Textures/ame_desert/desertsky_dn.tga",
		"../Textures/ame_desert/desertsky_rt.tga",
		"../Textures/ame_desert/desertsky_lf.tga" };
...
void init(int width, int height, std::string strTitle, bool bFullScreen) {
	...
	shaderMulLighting.initialize("../Shaders/cubeTexture.vs",
		"../Shaders/cubeTexture.fs");
	shaderMulLighting.initialize("../Shaders/iluminacion_texture_res.vs",
		"../Shaders/mulltipleLights.fs");
	...
	// Descomentar inicializacion de la esfera del skybox
	skyboxSphere.init();
	...
	while (psi) {
		...
		shaderMaterialLighting.setMatrix4("projection", 1, false,
		 ...
		 shaderMaterialLighting.setMatrix4("view", 1, false,
		       glm::value_ptr(view));
		 //setea la matriz de vista y projeccion al shader con miltuples luces
		...
		// Descomentar se cera cada vez que se cree un sader
		shaderSkybox.setMatrix4("projection", 1, false,
				glm::value_ptr(projection));
		shaderSkybox.setMatrix4("view", 1, false,
				glm::value_ptr(glm::mat4(glm::mat3(view)))); //par que no se sañga del skybox
		...
		// Descomentar
		 ...
		 shaderMaterialLighting.setVectorFloat3("material.ambient", glm::value_ptr(glm::vec3(0.1f, 0.18725f, 0.1745f)));
		 shaderMaterialLighting.setVectorFloat3("material.diffuse", glm::value_ptr(glm::vec3(0.396f, 0.74151f, 0.69102f)));
		 shaderMaterialLighting.setVectorFloat3("material.specular", glm::value_ptr(glm::vec3(0.297254f, 0.30829f, 0.306678f)));
		 shaderMaterialLighting.setFloat("material.shininess", 12.8f);
